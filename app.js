...
var budgetController = (function () {
    ...
    return {
        addItem: function(type, des, val) {
            ...
            //Create new item on the basis of inc or exp type
            if (type === 'exp') {
        ...
        calculateBudget: function() {
            ...
            //Calculate the expense percentage of income
...
var UIController = (function () {
    ...
    return { 
        getInput: function() {
            return {
                type: document.querySelector(DOMstrings.inputType).value,    //will be either inc or exp because select tag sends the option's value
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var ctrlAddItem = function () {
        ...
        //1. Get the input value from the field
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            //4. Clear the fields of input
            UICtrl.clearFields();

            //5. Calc adn Update budget
            updateBudget();
